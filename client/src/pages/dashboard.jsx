  ...
  const TableHeader = () => (
    <thead className="border-b border-gray-300 ">
      <tr className="text-black text-left">
        ...
        <th className="py-2 px-5">Team</th>
        <th className="py-2 px-3 hidden md:block">Created At</th>
      </tr>
    </thead>
  );
    ...
    <tr className="border-b border-gray-300 text-gray-600 hover:bg-gray-300/10">
      <td className="py-2">
        <div className="flex items-center text-wrap gap-2">
          <div
            className={clsx("w-4 h-4 px-2 rounded-full", TASK_TYPE[task.stage])}
          />
    ...
    <tr className="border-b border-gray-200  text-gray-600 hover:bg-gray-400/10">
      <td className="py-2">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 p-2 rounded-full text-white flex items-center justify-center text-sm bg-violet-700">
      ...
      <td>
        <p
          className={clsx(
            "w-fit px-2 py-1 mr-2 rounded-full text-sm",
      ...
      <td className="py-2 px-1 text-sm">{moment(user?.createdAt).fromNow()}</td>
    </tr>
  );
